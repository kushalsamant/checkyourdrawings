...
class Settings(BaseSettings):
    ...
    min_ink_pixel_ratio: float = 0.001
...
COMPARE_DEBUG: bool = _settings.compare_debug
MIN_INK_PIXEL_RATIO: float = _settings.min_ink_pixel_ratio
...
OVERLAY_AGREE_DILATION_RADIUS: int = _settings.overlay_agree_dilation_radius
CROP_ECC_MAX_PIXELS: int = _settings.crop_ecc_max_pixels
