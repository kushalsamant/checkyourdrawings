...
Why did `comparison-569dd276e92f48beb5ee3129b8c7b3d1.png` show **64.6% changed** and **18% red of changed** while canonical **0A vs 0B** runs show **21.3% changed**?

## Finding

**Not an alignment failure.** The outlier profile matches **cross-series revision compares** (different model stages), not 0A/0B.

| Pair | Changed % | Red % of changed | Inlier ratio | Confidence |
|------|-----------|----------------------|--------------|------------|
...
- High orange/blue/red counts reflect **comparing different floors** (0 vs 1 vs 2 vs 3), not a bug in Pass 1.
